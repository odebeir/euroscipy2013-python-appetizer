...
\institute{professor at the Université Libre de Bruxelles \\
\url{http://lisa.ulb.ac.be}}

\title{EuroScipy 2013 - A small python appetizer}
...
\begin{frame}
    ...
    \hspace{1em}
    \tiny\url{https://github.com/odebeir}
    \begin{tabular}[t]{lr}
        \mbox{\CcGroupBy{0.35}}  &
